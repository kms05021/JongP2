...
import com.lilly.bluetoothclassic.fragment.ChartFragment
import com.lilly.bluetoothclassic.fragment.HomeFragment
import com.lilly.bluetoothclassic.fragment.SettingFragment
        ...
        bnv_main.run { setOnNavigationItemSelectedListener {
            when(it.itemId) {
                ...
                R.id.second -> {
                    ...
                    supportFragmentManager.beginTransaction().replace(R.id.fl_container, chartFragment).commit()
                }
                R.id.third -> {
