...
import com.lilly.bluetoothclassic.Actions
import com.lilly.bluetoothclassic.AppService
...
class MainActivity : AppCompatActivity() {
    ...
    private fun stopForeground() {
        val intent = Intent(MyApplication.applicationContext(), AppService::class.java)
